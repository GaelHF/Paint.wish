...
class sketch_from_svg:
    ...
    def draw(self, retain=True, file=None, data=None, x_offset=0, y_offset=0, scale=None, pen = turtle.getpen()):
        if file != None:
...
class sketch_from_image:
    def __init__(self, path, save = False) -> None:
    ...
    def draw(self, threshold=127, pen = turtle.getturtle()):
